...
import controller.ControllerAcessoSistema;
import javax.swing.JPasswordField;
import javax.swing.JTextField;

public class frmAcessoSistema extends javax.swing.JFrame {

    public frmAcessoSistema() {
        initComponents();
        setExtendedState(frmAcessoSistema.MAXIMIZED_BOTH);
        setResizable(false);
        setLocationRelativeTo(null);
    }
    ControllerAcessoSistema controllerAcessoSistema = new ControllerAcessoSistema(frmAcessoSistema.this);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/autorizar.png"))); // NOI18N

        jLabel2.setText("Login:");

        jLabel3.setText("Senha:");

        btEntrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/ok.png"))); // NOI18N
    ...
    private void btEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEntrarActionPerformed
        this.controllerAcessoSistema.entrar();
    ...
    public static void main(String args[]) {
       //<editor-fold defaultstate="collapsed" desc=" Look and feel setting code (optional) ">
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmAcessoSistema.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new frmAcessoSistema().setVisible(true);
            }
        });
    }
